...
namespace NeuroGeneticAI.Genetics
{
    ...
    // Base class for all evolutionary strategies supported by the project.
    ...
    public abstract class MetaHeuristic : MonoBehaviour
    {
        ...
        // Selection strategies available for the run.
        ...
        // Gets the current red population.
        ...
        // Gets the current blue population.
        ...
        // Best red individual for the current generation.
        ...
        // Best blue individual for the current generation.
        ...
        // Initializes the population with random or seeded individuals.
        public abstract void InitPopulation ();
        //The Step function assumes that the fitness values of all the individuals in the population have been calculated.
        // Executes a single iteration of the metaheuristic.
        public abstract void Step();


        // Updates reporting structures and persists best individuals.
    ...
    // Writes best-of-run artifacts to disk and resets state.
    ...
    // Persists CSV statistics and controller snapshots.
    ...
    // Helper that appends text to a log file.
    ...
    // Serializes an individual controller to disk.
    ...
    // Loads a serialized neural network from disk.
